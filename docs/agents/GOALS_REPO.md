...
| --- | --- | --- | --- | --- | --- | --- |
| DOC-BOOTSTRAP-001 | G-ALPHA-005 | P0 | Alpha | completed | web-platform | Governance docs and checks are present and valid. |
| WEB-ALPHA-001 | G-ALPHA-002 | P0 | Alpha | completed | web | Returning authenticated users land on dashboard automatically. |
